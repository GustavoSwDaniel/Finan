...
const TableFinaciers = () => {
  ...
  const getCategories = async () => {
    const response = await axios.get("http://localhost:8081/financers?limite=12&offset=" + selectPage);
  ...
  return (
    ...
    <GenerateReport showModal={showModalReport} setShowModal={setShowModalReport} urlType={"all"}/>
    ...
    <div className="flex items-center justify-between">
      <div className="flex p-3">
          ...
          <span className="font-extrabold">
            ...
            Gerar relatorio de Receitas e Despesas
          </button>
      </div>
